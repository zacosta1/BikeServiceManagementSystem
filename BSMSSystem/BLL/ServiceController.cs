...
namespace BSMSSystem.BLL
{
    ...
    public class ServiceController
    {
        ...
        [DataObjectMethod(DataObjectMethodType.Update, false)]
        public void Update_ServiceDetailPart_Quantity(int serviceDetailPartId, short newQuantity)
        {
            using (var context = new BSMSContext())
            {
                ...
                int quantityDifference = serviceDetailPart.Quantity - newQuantity;

                //make the necessary update on the Parts Entity
                inventoryPart.QuantityOnHand += quantityDifference;
                context.Entry(inventoryPart).State = System.Data.Entity.EntityState.Modified;
                //update service detail part quantity
                serviceDetailPart.Quantity = newQuantity;
