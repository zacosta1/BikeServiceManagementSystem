...
public partial class User_Controls_MessageUserControl : System.Web.UI.UserControl
{
    ...
    private const string STR_TITLE_ICON_danger = "bi bi-x-octagon-fill mr-2 text-danger";
    ...
    {
        ShowInfo(message, title, STR_TITLE_ICON_info, STR_CARD_info);
    }
    /// <summary>
    /// Displays a message and title in the message panel with a general "error" display
    /// </summary>
    /// <param name="title">Title for the panel</param>
    /// <param name="message">Text to display as the message</param>
    public void ShowValidationError(string title, string message)
    {
        ShowInfo(message, title, STR_TITLE_ICON_danger, STR_CARD_danger);
    }
    /// <summary>
    ...
    public void TryRun(ProcessRequest callback, string title, string successMessage)
    {
        if (TryCatch(callback))
            ShowInfo(successMessage, title, STR_TITLE_ICON_success, STR_CARD_success);
    }
    /// <summary>
    ...
    private void HandleException(BusinessRuleException ex)
    {
        ...
        ShowExceptions(details, ex.Message, STR_TITLE_ValidationErrors, STR_TITLE_ICON_danger, STR_CARD_danger);
    }
    ...
    private void HandleException(DbEntityValidationException ex)
    {
        ...
        ShowExceptions(details, STR_TEXT_ValidationErrors, STR_TITLE_ValidationErrors, STR_TITLE_ICON_danger, STR_CARD_danger);
    }
    /// <summary>
    ...
    private void HandleException(Exception ex)
    {
        ...
        else
        {
            ...
            ShowExceptions(details, STR_TEXT_GeneralErrors, STR_TITLE_GeneralErrors, STR_TITLE_ICON_danger, STR_CARD_danger);
        }
    }
    /// <summary>
